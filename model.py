...
class Res50Unet():
    ...
    def create_model(self):
        ...
        inputs = tf.keras.layers.Input(shape=[24, 128, 128, 3], name="input", dtype=tf.float32)
        ...
        x = tf.keras.layers.Conv3D(name='conv3_block3_2_conv', filters=128, padding='same', kernel_size=(3,3,3), activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv3_block4_2_conv', filters=128, padding='same', kernel_size=(3,3,3), activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv4_block1_2_conv', filters=256, padding='same', kernel_size=(3,3,3), activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv4_block3_2_conv', filters=256, kernel_size=(3,3,3), padding='same', activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv4_block4_2_conv', filters=256, kernel_size=(3,3,3), padding='same', activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv4_block5_2_conv', filters=256, kernel_size=(3,3,3), padding='same', activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv4_block6_2_conv', filters=256, kernel_size=(3,3,3), padding='same', activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv5_block1_2_conv', filters=512, kernel_size=(3,3,3), padding='same', activation='linear')(x)
        ...
        x = tf.keras.layers.Conv3D(name='conv5_block3_2_conv', filters=512, kernel_size=(3,3,3), padding='same', activation='linear')(x)
...
def main():
    ...
    model = Res50Unet("test", decoder).create_model()
